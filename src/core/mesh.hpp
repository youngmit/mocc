...
public:
    ...
    */
    ...
    size_t n_surf() const
    {
        return (nx_ + 1) * ny_ * nz_ + (ny_ + 1) * nx_ * nz_ +
               (nz_ + 1) * nx_ * ny_;
    }
    ...
    {
        VecI d = {(int)nx_, (int)ny_, (int)nz_};
        return d;
    }
    ...
    */
    ...
    {
        return Position(cell % nx_, (cell % (nx_ * ny_)) / nx_,
                        cell / (nx_ * ny_));
    }
    ...
    */
    int coarse_surf_point(Point2 p, int cell, std::array<int, 2> &s) const;
                                                ...
                                                size_t cell2) const
    {
        ...
        for (auto is : AllSurfaces) {
            if (this->coarse_neighbor(cell1, is) == (int)cell2) {
                return std::pair<size_t, Surface>(this->coarse_surf(cell1, is),
                                                  is);
            }
        }
