...
class Current {
public:
    Current(CoarseData *data, const Mesh *mesh) : data_(data), mesh_(mesh)
    {
        return;
    }
    ...
    MOCC_FORCE_INLINE void upwind_work(const real_t *x, const real_t *y,
                                       const real_t *z, const Angle &ang,
                                       int group)
    {
...
#pragma omp atomic update
    ...
    MOCC_FORCE_INLINE void current_work(real_t psi_x, real_t psi_y,
                                        real_t psi_z, size_t i, Angle &ang,
                                        int group)
    {
        real_t w = ang.weight * HPI;
...
#pragma omp atomic update
     ...
     */
    MOCC_FORCE_INLINE void current_work(real_t psi_x, real_t psi_y, size_t i,
                                        Angle &ang, int group)
    {
        real_t w = ang.weight * PI;
